                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_content">
                            <div>
                                ...
                                if (isset($_GET['pesan'])) {
                                    if ($_GET['pesan'] == "gagal") {
                                        echo "<div class='alert alert-danger pt-2 pb-2'>Data dengan NIK tersebut sudah ada !</div>";
                                    }
                                }
                                ?>
                            </div>
                            <form class="form-label-left input_mask" action="tambahdatasantunanproses.php" method="POST">

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" id="nik" name="nik" placeholder="NIK / KIA" required>
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <input type="number" class="form-control has-feedback-left" id="hp" name="hp" placeholder="Hp / WhatsApp">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" placeholder="Tulis Deskripsi Penerima" name="ket" id="ket">
                                    </div>
                                </div>
