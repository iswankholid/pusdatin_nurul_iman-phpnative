...
$pdf->Cell(190, 7, 'Daftar Penerima Santunan Keseluruhan', 0, 1, 'C');
...
$pdf->Cell(15, 6, 'Aktif', 1, 1);

$pdf->SetFont('Arial', '', 10);

include '../koneksi.php';
$mahasiswa = mysqli_query($koneksi, "select * from penerima_santunan");
$nomor = 1;
