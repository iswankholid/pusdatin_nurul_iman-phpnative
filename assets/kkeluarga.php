                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td class=" last"> <a href="infokk.php?id=<?php echo $d['id']; ?>" class="badge badge-info">INFO</a>
                                                        <a href="editkk.php?id=<?php echo $d['id']; ?>" class="badge badge-success">EDIT</a>
                                                        <a href="hapuskk.php?id=<?php echo $d['id']; ?>" class="badge badge-danger">HAPUS</a>
